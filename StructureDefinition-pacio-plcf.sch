...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      ...
      <sch:assert test="count(f:extension[@url = 'http://pacioproject.org/StructureDefinition/assistance-required']) &lt;= 1">extension with URL = 'http://pacioproject.org/StructureDefinition/assistance-required': maximum cardinality of 'extension' is 1</sch:assert>
